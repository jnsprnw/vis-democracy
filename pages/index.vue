    ...
    <aside class="page-aside">
      ...
      <section class="tab intro" v-if="activeTab === 'intro'">
        <div class="content">
          ...
          <p>Each country that is included in the Economist’s index has one slice in the graphic. The width illustrates the share each country has of the cummulative population, land mass, and GDP respectively. The colour indicates the categories <LinkHover path="scores.regimeType" value="Full democracy" label="full democracies" />, <LinkHover path="scores.regimeType" value="Flawed democracy" label="flawed democracies" />, <LinkHover path="scores.regimeType" value="Hybrid regime" label="hybrid regime" /> and <LinkHover path="scores.regimeType" value="Authoritarian" label="authoritarian" />.</p>
      ...
      <section class="tab" v-if="activeTab === 'story'">
        <h3>Population</h3>
        <p>Only a small percentage of the population lives in countries with <LinkHover path="scores.regimeType" value="Full democracy" label="full democracies" />. A large number lives in <LinkHover path="scores.regimeType" value="Flawed democracy" label="flawed democracies" />, like <LinkHover path="cca3" value="IND" label="India" />, or <LinkHover path="scores.regimeType" value="Authoritarian" label="authoritarian regimes" />, like <LinkHover path="cca3" value="CHN" label="China" />.</p>
        ...
        <h3>Economy</h3>
        <p>When scaling countries according to their gross domestic product (GDP), it’s clear that <LinkHover path="scores.regimeType" value="Full democracy" label="full democracies" /> have a bigger share of the world’s economy than corresponding to their population or land mass. While democracy might be one indicator for economic productivity, other factors such as historical and geographic conditions and the market system must also be taken into account.</p>
