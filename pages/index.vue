    ...
    <aside class="page-aside">
      ...
      <section class="tab intro" v-if="activeTab === 'intro'">
        <div class="content">
          ...
          <p>Each country that is included in the Economist’s index constitutes one slice in the graphic. The countries are ordered by their democracy rank: the more left a country is placed the more democratic it is. The width illustrates the share each country has of the cumulative world population, land mass, and GDP respectively. <LinkHover path="cca3" value="CHN" label="China" />, for example, is home to ~&#8239;19&#8239;% of the world’s population, covers ~&#8239;7&#8239;% of the planet’s land surface and produces ~&#8239;15&#8239;% of the total GDP. The colours indicate the categories <LinkHover path="scores.regimeType" value="Full democracy" label="full democracy" />, <LinkHover path="scores.regimeType" value="Flawed democracy" label="flawed democracy" />, <LinkHover path="scores.regimeType" value="Hybrid regime" label="hybrid regime" /> and <LinkHover path="scores.regimeType" value="Authoritarian regime" label="authoritarian regime" />.</p>
      ...
      <section class="tab" v-if="activeTab === 'story'">
        ...
        <p>While the population in <LinkHover path="cca3" value="IND" label="the" />&ensp;<LinkHover path="cca3" value="CHN" label="two" /> most populous countries is almost equal, there are big differences when it comes to the average annual birth rates. In <LinkHover path="cca3" value="CHN" label="China" />, like in the <LinkHover path="cca3" value="USA" label="US" />, there are on average 12.49 births per 1,000 habitants, which is a small number compared to 19.55 and 21.14 in <LinkHover path="cca3" value="IND" label="India" /> and <LinkHover path="cca3" value="BGD" label="Bangladesh" /> respectively.</p>
        <h3>Land Mass</h3>
        ...
        <p>Although almost equal in terms of population, <LinkHover path="cca3" value="IND" label="India" /> and <LinkHover path="cca3" value="CHN" label="China" /> differ in terms of territory. This indicates a large difference in population density. While in <LinkHover path="cca3" value="CHN" label="China" />, there are 142 people per square kilometer of land, in <LinkHover path="cca3" value="IND" label="India" />, there are 380. For the <LinkHover path="cca3" value="USA" label="United States" /> the number is 32, and in <LinkHover path="cca3" value="BGD" label="Bangladesh" /> it is 1,138 – one of the highest densities in the world.</p>
        <h3>Economy</h3>
        <p>When scaling countries according to their gross domestic product (GDP, nominal), it is clear that <LinkHover path="scores.regimeType" value="Full democracy" label="full" /> and <LinkHover path="scores.regimeType" value="Flawed democracy" label="flawed democracies" /> have a bigger share of the world’s economy than corresponding to their population or land mass. While democracy might be one indicator of economic productivity, other factors such as historical and geographic conditions and the market system must also be taken into account.</p>
