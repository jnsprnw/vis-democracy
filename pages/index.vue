  ...
  <div class="page-body">
    <aside class="page-aside">
      ...
      <section class="tab" v-if="activeTab === 'story'">
        ...
        <h3>Economy</h3>
        <p>When scaling countries according to their gross domestic product (GDP), it is clear that <LinkHover path="scores.regimeType" value="Full democracy" label="full democracies" /> have a bigger share of the world’s economy than corresponding to their population or land mass. While democracy might be one indicator of economic productivity, other factors such as historical and geographic conditions and the market system must also be taken into account.</p>
        <p>While economic heavyweights <LinkHover path="cca3" value="CHN" label="China" /> and the <LinkHover path="cca3" value="USA" label="US" /> nearly match up to each other in absolute numbers, comparing the numbers per capita would draw a different picture. The GDP per capita is $&#8239;55,800 in the <LinkHover path="cca3" value="USA" label="United States" />, but only $&#8239;14,100 in <LinkHover path="cca3" value="CHN" label="China" />, $&#8239;6,200 in <LinkHover path="cca3" value="IND" label="India" />, and a mere $&#8239;3,600 in <LinkHover path="cca3" value="BGD" label="Bangladesh" />.</p>
      </section>
