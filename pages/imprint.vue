<template>
  <div class="wrapper imprint">
    ...
    <p>Jonas Parnow is a designer for information and data. Find out more about him at <a href="http://jonasparnow.de">jonasparnow.de</a> and see other projects at <a href="http://visualising.systems">visualising.systems</a>.
    ...
    <ul>
      <li><sup>[1]</sup> Palestine’s population and landmass is combined from the Gaza Strip and the West Bank respectively.</li>
      <li><sup>[2]</sup> Taiwan’s GDP is taken from <a href="https://en.wikipedia.org/wiki/Economy_of_Taiwan">Wikipedia</a></li>
      <li><sup>[3]</sup> More on Taiwan’s HDI index on <a href="https://en.wikipedia.org/wiki/List_of_countries_by_Human_Development_Index#cite_note-15">Wikipedia</a></li>
      <li><sup>[4]</sup> More on North Korea’s HDI index on <a href="https://en.wikipedia.org/wiki/List_of_countries_by_Human_Development_Index#cite_note-UN_Escap-9">Wikipedia</a></li>
      <li><sup>[5]</sup> Eritrea is technically listed as an observer instead of member.</li>
    </ul>
    <table>
      <thead>
        <tr>
